...
Protected Module SystemParametersWFS
	...
	#tag Method, Flags = &h1
		Protected Sub AccessTimeout(assigns set as AccessTimeoutWFS)
	...
	#tag Method, Flags = &h1
		Protected Function FilterKeys() As FilterKeysWFS
		  Const SPI_GETFILTERKEYS = &h32
		  dim mb as new MemoryBlock( 24 )
		  SystemParametersInfo( SPI_GETFILTERKEYS, mb.Size, mb, 0 )
		  
		  return new FilterKeysWFS( mb )
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub FilterKeys(assigns set as FilterKeysWFS)
	...
	#tag Method, Flags = &h1
		Protected Function IconLogicalFont() As LogicalFontWFS
		  ...
		  if unicodeSavvy then
		    logFont = new MemoryBlock( LogicalFontWFS.kWideCharSize )
		  else
		    logFont = new MemoryBlock( LogicalFontWFS.kANSISize )
		  end if
		  
		  SystemParametersInfo( SPI_GETICONTITLELOGFONT, 0, logFont, 0 )
		  
		  return new LogicalFontWFS( logFont, unicodeSavvy )
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub IconLogicalFont(assigns theFont as LogicalFontWFS)
	...
	#tag Method, Flags = &h1
		Protected Function IconMetrics() As IconMetricsWFS
		  dim unicodeSavvy as Boolean = System.IsFunctionAvailable( "SystemParametersInfoW", "User32" )
		  ...
		  return new IconMetricsWFS( mb, unicodeSavvy )
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub IconMetrics(assigns metrics as IconMetricsWFS)
	...
	#tag Method, Flags = &h1
		Protected Function MouseKeys() As MouseKeysWFS
		  Const SPI_GETMOUSEKEYS = &h36
		  dim mb as new MemoryBlock( 28 )
		  SystemParametersInfo( SPI_GETMOUSEKEYS, mb.Size, mb, 0 )
		  
		  return new MouseKeysWFS( mb )
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub MouseKeys(assigns set as MouseKeysWFS)
	...
	#tag Method, Flags = &h1
		Protected Function ToggleKeys() As ToggleKeysWFS
		  Const SPI_GETTOGGLEKEYS = &h34
		  dim mb as new MemoryBlock( 8 )
		  SystemParametersInfo( SPI_GETTOGGLEKEYS, mb.Size, mb, 0 )
		  
		  return new ToggleKeysWFS( mb )
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub ToggleKeys(assigns set as ToggleKeysWFS)
