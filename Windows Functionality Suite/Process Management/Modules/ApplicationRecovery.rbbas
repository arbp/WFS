#tag Module
Protected Module ApplicationRecovery
	...
	#tag Method, Flags = &h1
		Protected Sub RegisterRecoveryCallback(callback as ApplicationRecoveryCallbackProvider, param as UInt32)
		  #if TargetWin32
	...
	#tag Property, Flags = &h21
		Private mCallback As ApplicationRecoveryCallbackProvider
	#tag EndProperty
