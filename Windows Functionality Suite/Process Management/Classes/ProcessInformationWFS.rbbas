#tag Class
Protected Class ProcessInformationWFS
	#tag Method, Flags = &h0
		Sub BringToFront()
		  #if TargetWin32
	...
	#tag Property, Flags = &h0
		LoadedHeapLists(-1) As HeapListInformationWFS
	#tag EndProperty

	#tag Property, Flags = &h0
		LoadedModules(-1) As ModuleInformationWFS
	#tag EndProperty

	#tag Property, Flags = &h0
		LoadedThreads(-1) As ThreadInformationWFS
	#tag EndProperty
