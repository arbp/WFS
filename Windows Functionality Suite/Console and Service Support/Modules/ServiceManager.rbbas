#tag Module
Protected Module ServiceManager
	#tag Method, Flags = &h1
		Protected Sub AddService(ByRef serv as Service)
		  #if TargetWin32
	...
	#tag Method, Flags = &h1
		Protected Sub CloseService(serv as Service)
		  #if TargetWin32
	...
	#tag Method, Flags = &h21
		Private Sub FillServiceInformation(ByRef serv as Service)
		  #if TargetWin32
	...
	#tag Method, Flags = &h1
		Protected Sub ModifyService(serv as Service)
	...
	#tag Method, Flags = &h1
		Protected Function OpenService(name as String, access as Integer) As Service
		  dim serv as Service
	...
	#tag Method, Flags = &h1
		Protected Sub RemoveService(s as Service)
		  #if TargetWin32
