...
Protected Module PlugAndPlayWFS
	...
	#tag Method, Flags = &h21
		Private Sub HandleDeviceAdded(lParam as Integer)
		  ...
		  // stab at it
		  dim observer as GenericDeviceStateObserverWFS
	...
	#tag Method, Flags = &h21
		Private Sub HandleDeviceInterfaceAdded(dev_broadcast_deviceinterface as MemoryBlock)
		  ...
		  dim observer as DeviceInterfaceStateObserverWFS
	...
	#tag Method, Flags = &h21
		Private Sub HandleOEMAdded(dev_broadcast_oem as MemoryBlock)
		  ...
		  dim observer as OemStateObserverWFS
	...
	#tag Method, Flags = &h21
		Private Sub HandlePortAdded(dev_broadcast_port as MemoryBlock)
		  ...
		  dim observer as PortStateObserverWFS
	...
	#tag Method, Flags = &h21
		Private Function HandleQueryVolumeRemoved(dev_broadcast_volume as MemoryBlock) As Boolean
		  ...
		  // Let the port observers know about it
		  dim observer as VolumeStateObserverWFS
		  dim ret as Boolean
	...
	#tag Method, Flags = &h1
		Protected Sub WatchForDeviceInterfaceEvents(observer as DeviceInterfaceStateObserverWFS)
	...
	#tag Method, Flags = &h1
		Protected Sub WatchForGenericDeviceEvents(observer as GenericDeviceStateObserverWFS)
	...
	#tag Method, Flags = &h1
		Protected Sub WatchForOemDeviceEvents(observer as OemStateObserverWFS)
	...
	#tag Method, Flags = &h1
		Protected Sub WatchForPortDeviceEvents(observer as PortStateObserverWFS)
	...
	#tag Method, Flags = &h1
		Protected Sub WatchForVolumeDeviceEvents(observer as VolumeStateObserverWFS)
	...
	#tag Property, Flags = &h21
		Private mDeviceInterfaceObservers(-1) As DeviceInterfaceStateObserverWFS
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mObservers(-1) As GenericDeviceStateObserverWFS
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mOemObservers(-1) As OemStateObserverWFS
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mPortObservers(-1) As PortStateObserverWFS
	#tag EndProperty
	...
	#tag Property, Flags = &h21
		Private mVolumeObservers(-1) As VolumeStateObserverWFS
	#tag EndProperty
